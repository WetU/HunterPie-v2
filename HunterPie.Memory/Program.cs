...
internal class Program
{
    private static void Main()
    {
        ...
        Signatures mhrSignatures = new Signatures()
        {
            ...
            new("SAVE_ADDRESS", "48 8B 0D ?? ?? ?? ?? 48 85 ?? 74 ?? 48 83 ?? 10 00 75 ?? B0 01 0F B6 C0 85 C0 75 ?? 38 81 A0 00 00 00", 3),
            ...
            //TODO: Fix signature for this
            new("EVENTCAMERA_ADDRESS", "40 53 48 83 EC ?? 48 8B 05 ?? ?? ?? ?? 48 8B D9 80 B8 ?? ?? ?? ?? 00 0F 85 ?? ?? ?? ?? 48 8B", 9),
            ...
            new("FUNC_WIREBUG_HIDE_AIM_ADDRESS", "49 8B ?? ?? ?? ?? ?? 48 83 60 50 FE 49 83 BD ?? ?? ?? ?? 00", 7, false),
